...
const DATASET_PATH = 'C:/Users/Mehmet-PC/Desktop/tensorflow-examples/fashion-model/data/dataset/';
const DATA_URL =
    'http://fashion-mnist.s3-website.eu-central-1.amazonaws.com/train-images-idx3-ubyte.gz';
const ZIP_PATH =
    path.resolve(path.join(DATASET_PATH, 'train-images-idx3-ubyte.gz'));
const UNZIP_PATH =
    path.resolve(path.join(DATASET_PATH, 'train-images-idx3-ubyte'));
